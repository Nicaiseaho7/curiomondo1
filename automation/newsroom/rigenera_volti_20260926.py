...
JOBS = [
    (
        ...
        "Ultra-realistic editorial photograph of Pope Leo XIV, recognizable, face fully visible and turned toward the camera, in white cassock, among a large crowd at Place de la Concorde in Paris, the obelisk behind him, daylight. Never from behind. No readable text, no watermark.",
    ...
    (
        ...
        "Ultra-realistic editorial photograph of Antonio Tajani, recognizable, face fully visible and turned toward the camera, speaking outdoors with the Italian flag and the Farnesina building in Rome behind him. Never from behind. No readable text, no watermark.",
    ...
    (
        ...
        "fiorello-rai-v692",
        "Ultra-realistic editorial photograph of Rosario Fiorello, recognizable, face fully visible and turned toward the camera, outside the Rai headquarters on viale Mazzini in Rome, the Rai logo correct on the building. Never from behind. No extra text, no watermark.",
    ...
    (
        ...
        "Ultra-realistic editorial portrait of Fabio Pigozzi, recognizable, face fully visible and turned toward the camera, a sports-medicine doctor beside an athletics track, neutral expression, daylight. Never from behind. No readable text, no watermark.",
    ...
    (
        ...
        "Ultra-realistic editorial photograph of Donald Trump, recognizable, face fully visible and turned toward the camera, at the podium of the White House briefing room, journalists in front of him. Never from behind. No readable headlines, no watermark.",
    ...
    (
        ...
        "Ultra-realistic editorial photograph of Pope Leo XIV, recognizable, face fully visible and turned toward the camera, in white cassock inside Notre-Dame in Paris, near the baptismal font, worshippers behind him. Never from behind. No readable text, no watermark.",
    ...
    (
        ...
        "Ultra-realistic editorial photograph of Pope Leo XIV, recognizable, face fully visible and turned toward the camera, celebrating outdoors at Place de la Concorde, rows of chairs and the obelisk, morning light. Never from behind. No readable text, no watermark.",
    ...
    (
        ...
        "Ultra-realistic neutral editorial portrait of Masoud Pezeshkian, recognizable, face fully visible and turned toward the camera, indoors, the Iranian flag small and out of focus. Never from behind. No weapons, no raid, no readable text, no watermark.",
    ...
    (
        ...
        "trump-tregua-v698",
        "Ultra-realistic editorial photograph of Donald Trump, recognizable, face fully visible and turned toward the camera, seated in a White House office, neutral, no military scene, no readable documents, no watermark. Never from behind.",
    ...
    (
        ...
        "Ultra-realistic editorial photograph of Edward Mukiibi, recognizable, face fully visible and turned toward the camera, at an outdoor food market in Turin among bread, grains and vegetables, autumn light. Never from behind. No readable labels, no watermark.",
    ...
    (
        ...
        "bulega-ducati-v700",
        "Ultra-realistic editorial photograph of Nicolo Bulega, recognizable, face fully visible and turned toward the camera, helmet off, in Ducati racing leathers in the Cremona pit lane, a red Ducati behind him. Never from behind, never with the visor down. No readable numbers or sponsor text, no watermark.",
