...
def ebook_html() -> str:
    ...
    for i, (heading, paragraphs) in enumerate(BOOK_PAGES, 1):
        ...
        pages.append(f'<section{attrs}><span class="cm-book-kicker">eBook CurioMondo · 31 agosto 2026</span>{title_tag}{h}{ps}<span class="cm-book-page-number">{i} / {total}</span></section>')
