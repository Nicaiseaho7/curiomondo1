#!/usr/bin/env python3
"""Sostituisce l'hero meteo con la mappa editoriale etichettata v524."""
...
SOURCE = ROOT.parent / "generated_images/exec-9387f1f8-d07d-4e91-a974-972ad54a859a.png"
SLUG = "meteo-italia-oggi-settimana-23-28-settembre-2026"
VERSION = 524
ALT = (
    "Mappa meteo editoriale IA dell’Italia dal 23 al 28 settembre 2026, "
    "con città principali, confini regionali e simboli di sole e pioggia."
)
...
for filename in ("CURIOMONDO-RELEASE-STATE.json", "RELEASE-STATE.json"):
    ...
    state.update(site_version=VERSION, version=str(VERSION), currentVersion=VERSION,
                 last_update="mappa-meteo-etichettata-v524")
...
manifest["last_release"] = {
    ...
    "news_added": [],
    "news_updated": [SLUG],
    "change": "Mappa meteo con città, regioni, simboli e tendenza settimanale",
}
