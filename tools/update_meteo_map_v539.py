#!/usr/bin/env python3
"""Sostituisce l'hero meteo con la mappa editoriale aggiornata al 24 settembre."""
...
for filename in ("CURIOMONDO-RELEASE-STATE.json", "RELEASE-STATE.json"):
    ...
    state.update(site_version=VERSION, version=str(VERSION), currentVersion=VERSION,
                 last_update="mappa-meteo-aggiornata-v539")
...
manifest["last_release"] = {
    ...
    "news_added": [],
    "news_updated": [SLUG],
    "change": "Mappa meteo aggiornata al 24 settembre con condizioni regione per regione",
}
