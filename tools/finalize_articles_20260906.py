...
TARGETS = {
    "notizie/rybakina-vince-us-open-sabalenka-numero-uno-wta-13-settembre-2026.html": "rybakina-us-open-2026-ai-openai-v343",
}
...
print(json.dumps({"status":"ok","version":343,"new_articles":["/"+x for x in TARGETS],"homepage_top":[i["url"] for i in feed_items[:10]]}, ensure_ascii=False, indent=2))
