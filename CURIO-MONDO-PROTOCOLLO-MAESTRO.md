...
- **REGOLA PROPRIETARIA:** prima di pubblicare qualunque contenuto leggere integralmente `PROTOCOLLO-QUALITA-EDITORIALE-ADSENSE.md`. È vietato pubblicare articoli che siano soltanto riscritture, riassunti, traduzioni o aggregazioni di fonti esterne: ogni pagina deve offrire un contributo editoriale originale (selezione ragionata dei fatti, contesto, conseguenze, distinzione tra fatti e dichiarazioni, spiegazione dei termini difficili, almeno una conoscenza utile che resti valida oltre l'evento del giorno). Se non esistono informazioni verificate sufficienti per un articolo completo, originale e non ripetitivo, l'articolo non va pubblicato: nessuna scadenza, ciclo automatico o quota numerica può superare questo divieto.
- **12 gate obbligatori** per ogni articolo indicizzabile (dettaglio completo nel file dedicato): lunghezza 3.000–7.000 caratteri nel solo `.art-body`; almeno tre fonti attendibili e pertinenti; titolo/apertura/struttura originali; ogni paragrafo aggiunge un fatto nuovo; gancio di conoscenza verificato e utile; termini difficili spiegati alla prima comparsa; approfondimento evergreen collegato quando pertinente; autore, metodo editoriale e date reali visibili; tre collegamenti interni pertinenti; canonical/meta/JSON-LD/sitemap/archivio/ricerca/feed coerenti; dichiarazioni controverse attribuite con precisione; revisione editoriale finale che confermi la completezza della pagina. Il mancato superamento anche di un solo gate blocca la release.
