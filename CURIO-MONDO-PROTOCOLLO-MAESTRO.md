...
## Protocollo qualità editoriale e idoneità Google AdSense — v2.0 (5 settembre 2026, obbligatorio, fail-closed)
...
- **12 gate obbligatori** per ogni articolo indicizzabile (dettaglio completo nel file dedicato): lunghezza 3.000–7.000 caratteri nel solo `.art-body`; almeno tre fonti attendibili e pertinenti; titolo/apertura/struttura originali; ogni paragrafo aggiunge un fatto nuovo; gancio di conoscenza verificato e utile; linguaggio chiaro senza effetto glossario; approfondimento evergreen collegato quando pertinente; autore, metodo editoriale e date reali visibili; tre collegamenti interni pertinenti; canonical/meta/JSON-LD/sitemap/archivio/ricerca/feed coerenti; dichiarazioni controverse attribuite con precisione; revisione editoriale finale che confermi la completezza della pagina. Il mancato superamento anche di un solo gate blocca la release.
