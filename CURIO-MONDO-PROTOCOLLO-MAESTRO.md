...
- Le notizie seguono la piramide invertita e, di default, non usano H2/H3 nel corpo. Gli approfondimenti da 800 parole in su usano pochi titoletti informativi per favorire la scansione.
...
- **PERSONE VERE, LOGHI VERI — REGOLA PROPRIETARIA 21 settembre 2026:** le immagini devono essere fotorealistiche e raffigurare soggetti realmente esistenti. Vietato inventare protagonisti, volti generici, extra al posto di atleti o personaggi nominati, maglie lisce o loghi di fantasia. Per una persona pubblica: quel volto riconoscibile. Per una squadra: i giocatori e la maglia ufficiali (stemma, sponsor, fornitore, numeri). Prima di generare, usare foto di riferimento reali; se il lettore non riconoscerebbe il soggetto, scartare e rigenerare. Gli astanti di sfondo possono essere anonimi; il soggetto principale no.
...
## Protocollo qualità editoriale e idoneità Google AdSense — v4.0 (10 settembre 2026, obbligatorio, fail-closed)
- **REGOLA PROPRIETARIA:** prima di pubblicare qualunque contenuto leggere integralmente `PROTOCOLLO-QUALITA-EDITORIALE-ADSENSE.md`. È vietato pubblicare articoli che siano soltanto riscritture, riassunti, traduzioni o aggregazioni di fonti esterne. Ogni pagina deve offrire un contributo editoriale originale. La notizia non spiega parole difficili: usa un lessico chiaro e, quando serve un'analisi vera, collega o crea un approfondimento autonomo. Se non esistono informazioni verificate sufficienti, l'articolo non va pubblicato.
- **Gate obbligatorio** prima della scrittura: fonte primaria o due secondarie indipendenti, valore aggiunto dichiarabile, materia sufficiente e trattamento pratico dei servizi. Ogni pezzo deve avere almeno due valori aggiunti tra metodo, limite, confronto, utilità pratica, link a guida esistente o aggiornamento sostanziale. Il dettaglio e la checklist SÌ/NO sono nel file dedicato; un solo NO blocca la release.
