...
- **GANCIO DI CONOSCENZA OBBLIGATORIO:** durante la scrittura di ogni articolo individuare almeno un elemento interno alla notizia che offra un contesto utile anche oltre l’evento del giorno: un’istituzione, un’organizzazione, un meccanismo, una procedura, una tecnologia, una regola, un ruolo pubblico, un luogo strategico o un precedente storico. Integrarlo in modo semplice, concreto e accurato soltanto nella misura necessaria a capire il fatto. L’approfondimento deve nascere organicamente dalla notizia, non essere riempitivo né trasformarsi in una serie di definizioni.
...
- Non inserire titoli editoriali, etichette aggiunte, watermark commerciali o disclosure dentro l’immagine. Marchi e loghi reali sono ammessi quando appartengono naturalmente a un soggetto, prodotto, mezzo, edificio o luogo pertinente; sono vietati come decorazione o falsa sponsorizzazione. **Regola obbligatoria:** sotto ogni immagine IA deve comparire come `<figcaption>` visibile ESATTAMENTE la frase: `Illustrazione editoriale CurioMondo generata con IA per rappresentare questa notizia; non è una fotografia documentaria.` La disclosure non deve mai essere sovrapposta ai pixel del visual.
...
- **REGOLA OBBLIGATORIA DAL v303 (7 settembre 2026):** non esiste un minimo fisso di caratteri per le notizie. La lunghezza segue tipo di pezzo e materia verificata: servizi e bandi indicativamente 250–400 parole; dati da decodificare 500–800; wrap multi-evento 700–1.000 soltanto quando ogni blocco porta fatti nuovi. Ogni articolo deve contenere almeno due elementi reali di valore aggiunto. Corto e utile prevale su lungo e vuoto.
...
- Il predeploy deve bloccare card premium alterata, sottotitoli nella risposta quotidiana e duplicazioni testuali rilevabili automaticamente. La qualità sostanziale, il gate e i due valori aggiunti richiedono anche revisione editoriale umana/IA e non sono riducibili a un conteggio di caratteri.

## Protocollo qualità editoriale e idoneità Google AdSense — v3.0 (7 settembre 2026, obbligatorio, fail-closed)
- **REGOLA PROPRIETARIA:** prima di pubblicare qualunque contenuto leggere integralmente `PROTOCOLLO-QUALITA-EDITORIALE-ADSENSE.md`. È vietato pubblicare articoli che siano soltanto riscritture, riassunti, traduzioni o aggregazioni di fonti esterne: ogni pagina deve offrire un contributo editoriale originale (selezione ragionata dei fatti, contesto, conseguenze, distinzione tra fatti e dichiarazioni, almeno una conoscenza utile che resti valida oltre l'evento del giorno). Il testo deve essere chiaro senza spiegazioni automatiche o sistematiche di parole difficili; una precisazione è ammessa soltanto quando indispensabile per comprensione, accuratezza o sicurezza. Se non esistono informazioni verificate sufficienti per un articolo completo, originale e non ripetitivo, l'articolo non va pubblicato: nessuna scadenza, ciclo automatico o quota numerica può superare questo divieto.
- **Gate obbligatorio** prima della scrittura: fonte primaria o due secondarie indipendenti, valore aggiunto dichiarabile, materia sufficiente e trattamento pratico dei servizi. Ogni pezzo deve avere almeno due valori aggiunti tra metodo, limite, confronto, utilità pratica, una definizione necessaria, link a guida esistente o aggiornamento sostanziale. Il dettaglio e la checklist SÌ/NO sono nel file dedicato; un solo NO blocca la release.
- **Domanda guida pre-pubblicazione:** «Un lettore arrivato direttamente su CurioMondo, senza passare da Google, considererebbe questa pagina completa, affidabile e utile?». Se la risposta non è chiaramente sì, non pubblicare.
- **Pubblicità solo su pagine editoriali sostanziali:** vietato il codice AdSense su pagine vuote, in costruzione, di errore, di sola navigazione o di servizio (privacy, cookie, contatti e analoghe); gli annunci non devono mai oscurare o spingere fuori schermo il contenuto né indurre clic accidentali; le pagine `noindex` non devono contenere codice pubblicitario.
- **Approfondimenti evergreen indicizzabili:** ogni approfondimento evergreen deve essere una pagina autonoma indicizzabile (URL permanente, `index,follow`, canonical autoreferenziale, dati strutturati pertinenti, presenza in sitemap XML generale, collegamenti interni, indice di ricerca interno, contenuto in HTML) pur restando escluso dalla home page e raggiungibile solo da menu, indice Approfondimenti e link interni.
- Non dichiarare mai un contenuto di alta qualità soltanto perché supera una soglia di lunghezza o un controllo automatico: i controlli tecnici sono necessari ma non sostituiscono giudizio, verifica e utilità reale.
