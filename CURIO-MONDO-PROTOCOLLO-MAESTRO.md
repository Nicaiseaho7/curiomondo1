...
- **REGOLA OBBLIGATORIA DAL v248:** il corpo di ogni nuovo articolo di notizie e di ogni aggiornamento editoriale sostanziale deve contenere **minimo 2.000 e massimo 4.500 caratteri** di testo visibile. Il conteggio riguarda esclusivamente il corpo `.art-body`: titolo, sottotitolo, metadati, didascalie, fonti e correlati non concorrono al limite.
- **Non esistono eccezioni di lunghezza.** Se le informazioni verificate non bastano per arrivare a 2.000 caratteri senza ripetere o diluire i fatti, non creare un articolo autonomo: attendere nuovi elementi oppure integrare lo sviluppo in una storia esistente quando editorialmente corretto. Se il testo supera 4.500 caratteri, tagliare ridondanze, dettagli secondari e contesto non indispensabile.
...
- Il predeploy deve bloccare card premium alterata, sottotitoli nella risposta quotidiana e, per i contenuti soggetti alla regola v248, articoli fuori dal limite 2.000–4.500 o con duplicazioni testuali rilevabili automaticamente.
